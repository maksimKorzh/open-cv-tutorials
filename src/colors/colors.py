...
thresh, image_black = cv2.threshold(image_greyscale, 170, 255, cv2.THRESH_BINARY)

# display image in the window
#cv2.imshow('image.jpeg', image)                 # default view
#cv2.imshow('image.jpeg', image_greyscale)       # grayscale
cv2.imshow('image.jpeg', image_black)            # black and white image

# store output images
cv2.imwrite('image_greyscale.png', image_greyscale)
